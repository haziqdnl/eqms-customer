...
export class RegisterStatusComponent {
  ...
  public btnBackText: any = this.translate.instant('SCRN_REGISTER_STATUS.REG_BACK_TO_LOGIN');
  private getUrlParam() {
    ...
    if (this.urlParamType   == 'adhoc')                                                                             this.btnBackText = this.translate.instant('SCRN_REGISTER_STATUS.REG_BACK');
  }
